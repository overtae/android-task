...
interface SearchMedia {
    ...
    suspend fun getImageList(
        ...
        @Query("page") page: Int = 1, // 결과 페이지 번호, 1~50 사이, 기본 값 1
        @Query("size") size: Int = 80 // 한 페이지에 보여질 문서 수, 1~80 사이, 기본값 15
    ): ImageResponse
    ...
    suspend fun getVideoList(
        ...
        @Query("size") size: Int = 15 // 한 페이지에 보여질 문서 수, 1~30 사이, 기본값 15
    ): VideoResponse
}